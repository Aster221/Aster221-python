...
1.1 Data collection
Data source: Use public datasets on the Internet or collect user-generated content from social platforms (such as Twitter, Facebook, Weibo, etc.), including posts, comments, private messages, etc.
